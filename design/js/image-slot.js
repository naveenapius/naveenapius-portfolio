...
(() => {
  ...
  const stylesheet =
    ...
    // Bare mode: no frame fill / clip / ring — for transparent cutout PNGs
    // that should sit directly on the page with no visible plate behind them.
    ':host([bare]) .frame{background:transparent;overflow:visible}' +
    ':host([bare]) .ring{display:none}' +
